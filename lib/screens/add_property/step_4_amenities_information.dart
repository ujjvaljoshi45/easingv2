        ...
        for (int i = 0; i < AddPropertyProvider.instance.myAmenities.length; i++)
          Row(
            ...
            children: [
              ...
              Checkbox(
                value: AddPropertyProvider.instance
                    .myAmenities[AddPropertyProvider.instance.myAmenities.keys.toList()[i]],
                onChanged: (value) => setState(() => AddPropertyProvider.instance
                        .myAmenities[AddPropertyProvider.instance.myAmenities.keys.toList()[i]] =
                    value ??
