...
class _AddLocationPageState extends State<AddLocationPage> {
  ...
  _manageSave() {
    if (!_validate()) return;
    getPropertyProvider(context).streetAddress = streetAddress;
    getPropertyProvider(context).pinCode = pinCode;
    getPropertyProvider(context).city = 'myCity';
    getPropertyProvider(context).state = 'myState';
