...
class _AddLocationPageState extends State<AddLocationPage> {
  ...
  _validate() {
    return AddPropertyProvider.instance.property.name.isNotEmpty && AddPropertyProvider.instance.property.propertyType.isNotEmpty && AddPropertyProvider.instance.property.streetAddress.isNotEmpty && AddPropertyProvider.instance.property.pinCode.isNotEmpty && AddPropertyProvider.instance.property.city.isNotEmpty && AddPropertyProvider.instance.property.state.isNotEmpty;
  }
      ...
      child: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            space(20),
            TextField(decoration: const InputDecoration(hintText: 'Enter Property Name'),onChanged: (value) => setState(()=>propertyName=value),),
             space(20),
             TextField(decoration: const InputDecoration(hintText: 'Enter Street Address'),onChanged: (value) => setState(()=>streetAddress=value),),
            space(20),
            TextField(decoration: const InputDecoration(hintText: 'Enter Pin-Code'),onChanged: (value) => setState(()=>pinCode=value),keyboardType: TextInputType.number,),
            space(20),
            Row(children: [
